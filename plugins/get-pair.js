...
cmd({
    ...
    react: "✅",
    desc: "Get pairing code for UMAR-MD bot",
    category: "download",
    use: ".pair +421233418681",
    filename: __filename
    ...
    try {
        ...
        const response = await axios.get(`https://umarxmd.onrender.com/pair?phone=${encodeURIComponent(phoneNumber)}`);
        ...
        const doneMessage = "> *UMAR-MD PAIRING COMPLETED*";
