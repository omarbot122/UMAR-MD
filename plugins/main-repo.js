...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/omarbot122/UMAR-MD';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'KingTechX',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
        ...
        // Send audio
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/omarbot122/UMAR-DATA/raw/refs/heads/main/autovoice/menunew.m4a' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
